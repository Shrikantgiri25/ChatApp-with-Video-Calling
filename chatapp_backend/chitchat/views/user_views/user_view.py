...
class UserView(APIView):
    ...
    def get(self, request):
        try:
            ...
            all_userlist = User.objects.exclude(Q(id=user_id) | Q(status__in=[UserStatus.INACTIVE, UserStatus.NOT_VERIFIED])).select_related("profile").only("id", "email", "status", "profile__profile_picture", "profile__bio")
